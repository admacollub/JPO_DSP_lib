...
int main()
{
    ...
    af::ChebyshevHighpass<double> HP_filter(44100.0, "IIR HPF", 2 , 100.0, 1.0);
    std::vector<double> coeffs_b = HP_filter.get_coeff_b();
    std::vector<double> coeffs_a = HP_filter.get_coeff_a();
    
    std::cout << "IIR HPF coeffitients:b = [ ";
